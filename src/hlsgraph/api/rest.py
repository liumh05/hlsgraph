...
def openapi_document() -> dict[str, Any]:
    ...
    query_parameters: dict[str, list[tuple[str, bool, str, str]]] = {
        ...
        "/api/v1/retrieve": [
            ...
            ("view", False, "string", "architecture or evidence view"),
            ("planes", False, "string",
             "comma-separated facts,evidence,knowledge,local,predictions; predictions also require explicit opt-in"),
            ...
            ("include_predictions", False, "boolean",
             "authorize and add the separate prediction-hypothesis plane"),
        ],
        "/api/v1/entities": [
